// Site-wide constants. Edit contact details here.

export const SITE_TITLE = 'Felix Haba';
export const SITE_DESCRIPTION = 'Writing about engineering, healthcare and books';
export const TAGLINE = 'Writing about engineering, healthcare and books';
