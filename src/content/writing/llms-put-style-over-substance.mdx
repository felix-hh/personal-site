...
My advice, in this age, is to put substance over style, at least for as long as we humans have some edge over LLMs, which I am optimistic will be a long time. Even if some LLM mis-users catch on to the idea that excessive style gives them away and change the output style of their LLM to be less slick to try and blend in, my advice is to actually grapple with important problems and use your own voice. This will help yourself find better, truer answers to your questions and develop opinions. It will help your readers trust that your writing put a piece of you at stake, that somebody cared enough about the idea to carefully craft that piece. 

Use LLMs to enhance you, not to replace you.
